...
from .views import HomeView, TaskCreateView, User, Task, TaskUpdateView, TaskDetailView, TaskDeleteView, UserCreationForm, AdminUserList
...
class TaskUpdateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.task = Task.objects.create(title='Test Title', text='Test Text', user=self.user)
